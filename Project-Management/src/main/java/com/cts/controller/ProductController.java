...
public class ProductController {
	...
	void updateProduct(@RequestBody Product product, @PathVariable int productId) {
	 ...
	 public  Collection<Vendor> tolerence(){
		 System.out.println("server down");
	        return Arrays.asList(new Vendor(500, "df", "dsf", "7416565985", "bala@gmail.com"),
	        		new Vendor(501, "df", "dsf", "7416565985", "bala@gmail.com")
	        		            );
	   }
